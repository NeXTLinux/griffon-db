...
import (
	...
	"github.com/nextlinux/griffon-db/cmd/griffon-db/cli"
...
func main() {
	...
	// note: it is important to always do signal handling from the main package. In this way if griffon-db is used
